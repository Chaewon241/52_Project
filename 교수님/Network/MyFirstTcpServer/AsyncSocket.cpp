...
namespace netfish
{
	netfish::AsyncSocket::AsyncSocket()
	{
	}
	...
	bool netfish::AsyncSocket::Connect(const char* ip, int port)
	{
		//TODO:
		return false;
	}

	void netfish::AsyncSocket::Close()
	{
	...
	int netfish::AsyncSocket::Recv(char* buf, int len)
	{
