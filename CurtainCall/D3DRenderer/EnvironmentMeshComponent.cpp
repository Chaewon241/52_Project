...
//{
//	m_EnvironmentTextureResource = ResourceManager::GetInstance()->CreateTextureResource(filePath);
...
//{
//	m_IBLDiffuseTextureResource = ResourceManager::GetInstance()->CreateTextureResource(filePath);
...
//{
//	m_IBLSpecularTextureResource = ResourceManager::GetInstance()->CreateTextureResource(filePath);
...
//{
//	m_IBLBRDFTextureResource = ResourceManager::GetInstance()->CreateTextureResource(filePath);
